...
// ✅ Fetch all active Finland articles
export async function getAllArticles(): Promise<Article[]> {
  return await prisma.newsArticle.findMany({
    where: { newsArticleStatus: "ACTIVE", newsLocation: "Finland" },
    select: {
      id: true,
      createdAt: true,
      isFeatured: true,
...
export async function getLastFeaturedArticle(): Promise<Article | null> {
  return await prisma.newsArticle.findFirst({
    where: { newsArticleStatus: "ACTIVE", isFeatured: true, newsLocation: "Finland" },
    select: {
      id: true,
      createdAt: true,
      isFeatured: true,
...
export default async function FinlandNews() {
