...
export default function VisitorTracker() {
  ...
  return (
    <div className="fixed bottom-2 right-4 bg-accent-foreground bg-opacity-80 text-primary w-6 h-6 flex items-center justify-center rounded-full text-xs font-semibold z-50 shadow-lg">
      {activeUsers}
    </div>
  );
}
