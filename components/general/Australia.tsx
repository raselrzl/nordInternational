...
async function getAustraliaNews(): Promise<Article[]> {
...
export default async function AustraliaLatest() {
  const articles = await getAustraliaNews();
    ...
    <section className="px-2">
      <div className="flex justify-between text-xl w-[160px] bg-black text-orange-600">
        ...
        >
          ...
          />
          <span className="text-md font-bold uppercase">australia</span>
        </Link>
      </div>
